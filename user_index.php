		...
		<div id="background">
			...
			<div id="body_login"><center>
				<form action="user_index.php" name="MainPage" method="post">
							...
							<input type="submit" value="Startseite" class="myButton_A">
				</form>
				...
				<form action="user_radio.php" name="MainPage" method="post">
							<input type="hidden" name="keyset" value="<?php echo $Key;?>">
							<input type="submit" value="Internetradio" class="myButton_IA">
				</form>
			...
			<div id="main_main">
				<div id="main_head">
					<div id="main_head_LOGOleft"></div>
					<div id="main_head_LOGOright"></div>
					<center>
					<h4 class="top0text">
					Willkommen
					</h4>
